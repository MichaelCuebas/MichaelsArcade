    ...
    if(showingWinScreen) {
    canvasContext.fillStyle = '#d600ff'
    ...
    colorRect(0,paddle1Y,PADDLE_THICKNESS,PADDLE_HEIGHT,'#d600ff');

    // this is right computer paddle
    colorRect(canvas.width-PADDLE_THICKNESS,paddle2Y,PADDLE_THICKNESS,PADDLE_HEIGHT,'#d600ff');

    //next line draws the ball
    colorCircle(ballX, ballY, 10, '#d600ff');
